...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณRetHTML   บAutor  ณMicrosiga           บ Data ณ  01/07/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Funcao para gerar HTML do boleto bancario a ser enviado porบฑฑ
ฑฑบ          ณ e-mail conforme chamada atrav้s da funcao __BOLETO.        บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
//Local cSequencial := Soma1(StrZero(Val(AllTrim(SEE->EE_FAXATU)),8))   //Alterado em 05/01/2018                     ท
Local cSequencial := SEE->EE_FAXATU   //Alterado em 17/04/2024                     ท
...
local cNNumSDig := cSequencial //alterado em 17/04/2024    
...
//cNossoNum := cCarteira + cSequencial + cNNumDac //109/000003359 PARA IMPRESSรO
cNossoNum := cSequencial //109/000003359 PARA IMPRESSรO - alterado 17/04/2024


//cNossNumGrav := cSequencial + cNNumDac //000003359 PARA gravar NA SE1
...
//		SEE->EE_FAXATU := cSequencial 
		SEE->EE_FAXATU := Soma1(cSequencial)   //alterado em 17/04/2024
		SEE->(MsUnLock())
	EndIf 
...
Local cCarteira		:= SEE->EE_CODCART
//Local cSequencial := StrZero(Val(SEE->EE_FAXATU),2)	//comentado em alterado em 175/04/2024
Local cConta 	 	:= STRZERO(VAL(SEE->EE_CONTA),5)+SEE->EE_DVCTA
Local cAgencia		:= STRZERO(VAL(SEE->EE_AGENCIA),4) //Right(SEE->EE_AGENCIA,4)
