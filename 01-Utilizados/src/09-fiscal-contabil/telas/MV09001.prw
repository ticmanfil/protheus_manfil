...
Data da Criacao---: 01/01/2019
===============================================================================================================================
Descrição---------: Este programa serve para Acertar Serie e Sequencia de Notas de Saidas
===============================================================================================================================
...
//	Local oMainWnd
	...
	//private oDlgPrinc
	private cCadastro 	:= '[MV09001] - Acerto de Sequencia Notas Saídas'
...
//	oBrowse:SetOwner( oPanel ) // Aqui se associa o browse ao componente de tela
	...
	oBrowse:SetMenuDef( 'MV09001' ) // Define de que fonte vem os botoes deste browse
...
//	Criagat(oStrSX5,oStrSX51)
	...
	oModel	:= MPFormModel():New('MV09001_MVC', /*bPreValidacao*/, /*bPosValidacao*/,/*bCommit*/, /*bCancel*/ )
...
//	oModel:SetRelation('GRID_SX51',{{'X5_FILIAL','xFilial("SX5")'}, {'X5_TABELA', 'X5_CHAVE'}}, SX5->(IndexKey(1)))
	...
	oModel:setDescription('[MV09001] - Acerto de Sequencia Notas Saídas')
//	oModel:GetModel('GRID_SX51'):setDescription('[MV09001] - Itens')
...
static function ViewDef()
	...
	local oModel	:= FWLoadModel('MV09001')	//nome do fonte que esta criado a estrutura de dados
...
static function MenuDef()
	...
	aadd(aRotina,{'Visualizar'	, 'VIEWDEF.MV09001', 0, 2, 0, nil})
	aadd(aRotina,{'Incluir'		, 'VIEWDEF.MV09001', 0, 3, 0, nil})
	aadd(aRotina,{'Alterar'		, 'VIEWDEF.MV09001', 0, 4, 0, nil})
	aadd(aRotina,{'Excluir'		, 'VIEWDEF.MV09001', 0, 5, 0, nil})
//	aadd(aRotina,{'Imprimir'	, 'VIEWDEF.MV09001', 0, 8, 0, nil})
