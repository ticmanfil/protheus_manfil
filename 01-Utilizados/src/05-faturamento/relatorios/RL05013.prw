...
===============================================================================================================================
Descrição---------: Este programa serve para gerar relatorio de MOTIVOS DE CANCELAMENTO
===============================================================================================================================
...
static function RptDef(cNome)
	...
	oReport	:= TReport():New(cNome,'RELATÓRIO DE MOTIVOS CANCELAMENTOS '+mv_par01,cNome,{|oReport| ReportPrint(oReport)},'RELATÓRIO DE MOTIVOS CANCELAMENTOS - '+mv_par01)
	...
	TRCell():New(oSection1,'MOTIVO'		,'TB1TMP',U_UX3Titulo('A3_NOME')	,x3Picture('A3_NOME')	,tamsx3('A3_NOME')[1]	,.F.,,'LEFT'	,,'LEFT',,,.F.,)
	TRCell():New(oSection1,'QTD'		,'TB1TMP','QUANTIDADE'				,'@E 999,999,999,999,999',16,.F.,,'RIGHT'	,,'RIGHT',,,.F.,)

	//configurando o totalizador
	//TRFunction():New(<oCell>,<cName>,<cFunction>,<oBreak>,<cTitle>,<cPicture>,<uFormula>,<lEndSection>,<lEndReport>,<lEndPage>,<oParent>,<bCondition>,<lDisable>,<bCanPrint>)
	TRFunction():New(oSection1:Cell('QTD'),nil,'SUM',,,'@E 999,999,999,999,999',,.T.,.T.,.T.,oSection1)
...
static function ReportPrint(oReport) 
	...
	//while !Eof()
		...
		oSection1:Cell('MOTIVO'):SetValue(TB1TMP->MOTIVO)
...
static function Query(pPeriodo)
	...
	cQuery	:='exec dbo.PR_RL05013 @mes = "'+pPeriodo+'"
