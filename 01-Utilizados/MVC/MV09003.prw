...
user function MV09003()

//	Local oMainWnd
	//Local aCoors := FWGetDialogSize( oMainWnd )
	//Local oPanel, oFWLayer, oBrowse
	local oBrowse  
	local cFiltroTela	:= 'X5_TABELA == "21"'
	//private oDlgPrinc
	private cCadastro 	:= '[MV09003] - Cad. Grp. Tributado'
...
//	oBrowse:SetOwner( oPanel ) // Aqui se associa o browse ao componente de tela
	...
	oBrowse:SetMenuDef( 'MV09003' ) // Define de que fonte vem os botoes deste browse
...
//	Criagat(oStrSX5,oStrSX51)
	...
	oModel	:= MPFormModel():New('MV09003_MVC', /*bPreValidacao*/, /*bPosValidacao*/,/*bCommit*/, /*bCancel*/ )
...
//	oModel:SetRelation('GRID_SX51',{{'X5_FILIAL','xFilial("SX5")'}, {'X5_TABELA', 'X5_CHAVE'}}, SX5->(IndexKey(1)))
	...
	oModel:setDescription('[MV09003] - Cad. Grp. Tributado')
//	oModel:GetModel('GRID_SX51'):setDescription('[MV09003] - Itens')
...
static function ViewDef()
	...
	local oModel	:= FWLoadModel('MV09003')	//nome do fonte que esta criado a estrutura de dados
...
static function MenuDef()
	...
	aadd(aRotina,{'Visualizar'	, 'VIEWDEF.MV09003', 0, 2, 0, nil})
	aadd(aRotina,{'Incluir'		, 'VIEWDEF.MV09003', 0, 3, 0, nil})
	aadd(aRotina,{'Alterar'		, 'VIEWDEF.MV09003', 0, 4, 0, nil})
	aadd(aRotina,{'Excluir'		, 'VIEWDEF.MV09003', 0, 5, 0, nil})
//	aadd(aRotina,{'Imprimir'	, 'VIEWDEF.MV09003', 0, 8, 0, nil})
...
static function SetPropM(oStrSX5)
    ...
    oStrSX5:SetProperty('X5_TABELA',   MODEL_FIELD_INIT,    FwBuildFeature(STRUCT_FEATURE_INIPAD,  '"21"'))                     //Ini Padrão
