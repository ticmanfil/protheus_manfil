...
===============================================================================================================================
Descriï¿½ï¿½o---------: Este programa serve para GERAR E IMPRIMIR OS BOLETOS ITAU EM LOTE E DANFE/NFCe
===============================================================================================================================
Uso---------------: Faturamento
===============================================================================================================================
...
user function MV05002()
	...
	//private oDlgPrinc
	private cCadastro 	:= '[MV05002] - Impressão de Boletos Itaú e DANFE/NFCe'
	private oMark
	...
	u_msgInforma('Rotina em manutenção!!!..',cCadastro)
...
/*	oMark:= FWMarkBrowse():New()
	oMark:SetAlias( 'SF2' )
	oMark:SetMenuDef( 'MV05002' ) 		// Define de que fonte vem os botoes deste browse
...
static function ModelDef
	...
	local oStrSF2	:= FWFormStruct(1,'SF2', { |cCampo| VerCampo(cCampo) } )	//1 ou 2
	
	/* Definir modelo de dados */
	oModel	:= MPFormModel():New('MV05002_MVC', /*bPreValidacao*/, /*bPosValidacao*/,/*bCommit*/, /*bCancel*/ )
	
	/* editar propriedades do modelo de dados */
	oModel:addFields('FIELD_SF2',,oStrSF2)

	oModel:setDescription('[MV05002] - Geração de Boleta Itaú')
...
static function ViewDef()
	...
	local oModel	:= FWLoadModel('MV05002')	//nome do fonte que esta criado a estrutura de dados
...
user function MV05002C() //Marcar todos os registros
	local	aArea		:= getArea(),;
			aSF2		:= SF2->(getArea()),;
			cMarca		:= oMark:Mark()
...
user function MV05002D() //Desmarcar todos os registros
	local	aArea		:= getArea(),;
			aSF2		:= SF2->(getArea()),;
			cMarca		:= oMark:Mark()
