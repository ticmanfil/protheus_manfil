...
===============================================================================================================================
Descri็ใo---------: Este programa serve para imprimir boletas do banco ITAU
===============================================================================================================================
Uso---------------: No pedido de vendas (faturamento) e Fun็๕es de Contas a Receber (financeiro)
===============================================================================================================================
Parametros--------: Nenhum
===============================================================================================================================
Retorno-----------: sem retorno
...
ฑฑบPrograma  ณRFIN002E  บAutor  ณMicrosiga           บ Data ณ  01/07/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณMontagem e impressao do boleto bancario.                    บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function RFIN002E(cTitulos,email,cFuncao,cNomePDF,plViewPDF,pLocal)
	...
	_cNomeArq := AllTrim("BOLETO")+"_"+cValToChar(TMPBOL1->REGSE1)+ "_" + dToS(Date()) + "_" + StrTran(Time(), ":", "-")
	If nTipo == "1"
		lPreview := .T.
	...
	While TMPBOL1->(!Eof())
		...
		IF !Empty(SE1->E1_NUMBCO)	//_lReimprime	
			...
			//recuperando os nosso numero com base no retorno do codigo de barras salvo anteriormente
			cNNumImp		:= substring(cCodigoBarras,20,3) + '/' + substring(cCodigoBarras,23,8) + '-' + substring(cCodigoBarras,31,1)
			cNossoNum		:= substring(cCodigoBarras,20,12)
		...
		aMsgs[5] := "APำS VENCIMENTO COBRAR JUROS POR DIA DE R$ " + TransForm(nJuros,"@E 9,999,999.99") 
		aMsgs[6] := "APำS VENCIMENTO COBRAR MULTA DE         R$ " + TransForm(nMulta,"@E 9,999,999.99")

		//aMsgs[7] := "NรO RECEBER APำS DATA DO VENCIMENTO"			  	
		//aMsgs[7] := "NรO RECEBER APำS 3 DIAS DA DATA DO VENCIMENTO"			  	
		aMsgs[7] := "NรO RECEBER APำS "+cValToChar(SEE->EE_ITAUPRT)+" DIAS DA DATA DO VENCIMENTO"			  	
		aMsgs[8] :=	"BORDERO: " + AllTrim(SE1->E1_NUMBOR)
		aMsgs[9] :=	"Nota Fiscal: " + AllTrim(SE1->E1_PREFIXO)+AllTrim(SE1->E1_NUM)
	//	aMsgs[7] := "Sujeito a inclusใo no SERASA/SPC ou protesto em 5 dias, Pgto exclusivo em banco. Nใo fazer pagto via DOC, TED, DEPOSITO, "
	//	aMsgs[8] :=	"o sistema nใo identifica estes Pagtos. Nใo Pagar a TERCEIROS ou REPRESENTANTES."
		...
		ELSEIF SEE->EE_CODIGO == "104"
			oPrint:Say(aPosicoes[POS_LOCPAGTO1,1],aPosicoes[POS_LOCPAGTO1,2],"PREFERENCIALMENTE NAS CASAS LOTษRICAS ATษ O VALOR LIMITE",oFonte1)
		ELSEIF SEE->EE_CODIGO == "341"
			oPrint:Say(aPosicoes[POS_LOCPAGTO1,1],aPosicoes[POS_LOCPAGTO1,2],"ATษ O VENCIMENTO EM QUALQUER BANCO OU CORRESPONDENTE NรO BANCมRIO. APำS O VENCIMENTO,",oFonte1)
			oPrint:Say(aPosicoes[POS_LOCPAGTO1,1]+30,aPosicoes[POS_LOCPAGTO1,2],"ACESSO ITAU.COM.BR/BOLETOS E PAGUE EM QUALQUER BANCO OU CORRESPONDENTE NรO BANCมRIO.",oFonte1)		
		...
		ELSEIF SEE->EE_CODIGO == "341" 
			//oPrint:Say(aPosicoes[POS_NUMTIT2  ,1],aPosicoes[POS_NUMTIT2  ,2],AllTrim(SEE->EE_CODCART)+"/"+SubStr(SE1->E1_NUMBCO,1,8)+"-"+SubStr(SE1->E1_NUMBCO,12,1),oFonte4,,,,1)	
			oPrint:Say(aPosicoes[POS_NUMTIT2  ,1],aPosicoes[POS_NUMTIT2  ,2],cNNumImp,oFonte4,,,,1)	
		ELSEIF SEE->EE_CODIGO == "033" 
		...
		ELSEIF SEE->EE_CODIGO == "104"
			oPrint:Say(aPosicoes[POS_LOCPAGTO2,1],aPosicoes[POS_LOCPAGTO2,2],"PREFERENCIALMENTE NAS CASAS LOTษRICAS ATษ O VALOR LIMITE",oFonte1)
		ELSEIF SEE->EE_CODIGO == "341"
			oPrint:Say(aPosicoes[POS_LOCPAGTO2,1],aPosicoes[POS_LOCPAGTO2,2],"ATษ O VENCIMENTO EM QUALQUER BANCO OU CORRESPONDENTE NรO BANCมRIO. APำS O VENCIMENTO,",oFonte1)
			oPrint:Say(aPosicoes[POS_LOCPAGTO2,1]+30,aPosicoes[POS_LOCPAGTO2,2],"ACESSO ITAU.COM.BR/BOLETOS E PAGUE EM QUALQUER BANCO OU CORRESPONDENTE NรO BANCมRIO.",oFonte1)		
		ELSE
		...
		ELSEIF SEE->EE_CODIGO == "341" 
			//oPrint:Say(aPosicoes[POS_NUMTIT3  ,1],aPosicoes[POS_NUMTIT3  ,2],AllTrim(SEE->EE_CODCART)+"/"+StrZero(val(SE1->E1_NUMBCO),11)+"-"+SubStr(SE1->E1_NUMBCO,12,1),oFonte4,,,,1)
			oPrint:Say(aPosicoes[POS_NUMTIT3  ,1],aPosicoes[POS_NUMTIT3  ,2],cNNumImp,oFonte4,,,,1)	
		ELSEIF SEE->EE_CODIGO == "033" 
	...
	//			If WFBOLETO(Alltrim(SA1->A1_EMAIL)+";renato.filho@manfil.com.br",SA1->A1_NOME,_cTituloImp,_cAnexo)	
					IF ALLTRIM(FUNNAME()) <> "AGLT044"
						MsgInfo("E-mail enviado com sucesso para o endere็o: "+Alltrim(SA1->A1_EMAIL))
					ENDIF
				EndIf		
				FERASE(_cAnexo) //Apaga aruqivo no servidor
			Else
				Alert("Falha ao copiar arquivo PDF do boleto, o e-mail nใo serแ enviado!")
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ__LAYOUT  บAutor  ณMicrosiga           บ Data ณ  01/07/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณImprime layout do boleto bancario.                          บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
IF SA6->A6_COD =='104'
	oPrint:Say(450,060,"SAC CAIXA: 0800 726 0101 (informa็๕es, reclama็๕es, sugest๕es e elogios)",oFonte6)
	oPrint:Say(480,060,"Para pessoas com defici๊ncia auditiva ou de fala: 0800 726 2492",oFonte6)
...
// linha 3
	oPrint:Say(_nLin+296,060,"Nome do Beneficiแrio / CNPJ / CPF / Endere็o:",oFonte6)
	aPosicoes[11] := {_nLin+325,060}
	oPrint:Say(_nLin+296,1847,"Ag๊ncia/C๓digo Beneficiแrio",oFonte6)
...
// linha 4
	...
	oPrint:Say(_nLin+386,798,"Esp้cie do Doc.",oFonte6)
	...
	oPrint:Say(_nLin+386,1847,"Nosso N๚mero",oFonte6)
...
// linha 5	
	...
	oPrint:Say(_nLin+476,798,"Esp้cie",oFonte6)
...
// linha 6
	oPrint:Say(_nLin+566,060,"Instru็๕es (Texto de Responsabilidade do BENEFICIมRIO. Qualquer d๚vida sobre este boleto contate o beneficiแrio.)",oFonte6)
	...
	oPrint:Say (_nLin+656 ,1847,"(-)Outras Dedu็๕es",oFonte6)
	...
	oPrint:Say (_nLin+836 ,1847,"(+)Outros Acr้scimos",oFonte6)
...
// linha 7
	...
	oPrint:Say(_nLin+1105,1570,"Autentica็ใo Mecโnica / Ficha de Compensa็ใo",oFonte6)
...
// linha 3
	oPrint:Say(_nLin+1796,060,"Nome do Beneficiแrio / CNPJ / CPF / Endere็o:",oFonte6)
	aPosicoes[38] := {_nLin+1825,060}
	
	oPrint:Say(_nLin+1796,1847,"Ag๊ncia/C๓digo  Beneficiแrio",oFonte6)
...
// linha 4
	...
	oPrint:Say(_nLin+1886,798,"Esp้cie do Doc.",oFonte6)
	...
	oPrint:Say(_nLin+1886,1847,"Nosso N๚mero",oFonte6)
...
// linha 5
	...
	oPrint:Say(_nLin+1976,798,"Esp้cie",oFonte6)
...
// linha 6
	oPrint:Say(_nLin+2066,060,"Instru็๕es (Texto de Responsabilidade do BENEFICIมRIO. Qualquer d๚vida sobre este boleto contate o beneficiแrio.)",oFonte6)
	...
	oPrint:Say(_nLin+2156,1847,"(-)Outras Dedu็๕es",oFonte6)
	...
	oPrint:Say(_nLin+2336,1847,"(+)Outros Acr้scimos",oFonte6)
...
// linha 7
	...
	oPrint:Say(_nLin+2605,1570,"Autentica็ใo Mecโnica / Ficha de Compensa็ใo",oFonte6)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ__VLRCNAB บAutor  ณMicrosiga           บ Data ณ  01/07/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณRetorna o valor do titulo considerando os abatimentos       บฑฑ
ฑฑบ          ณe acrescimos.                                               บฑฑ
ฑฑบ          ณRetorna o valor do juros por dia de atraso       			  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ__MODULO10บAutor  ณMicrosiga           บ Data ณ  01/07/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Calculo do digito verificador atraves do Modulo10          บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ__MODULO11บAutor  ณMicrosiga           บ Data ณ  01/07/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Calculo do digito verificador atraves do Modulo11          บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
...
ElseIf  cBanc == "104" //Caixa
	...
	EndDo
    D := 11 - (mod(D,11))
	If !Empty(nBaseDv) //Regra para digito geral do codigo de barras que nใo aceita 0
		If (D > 9 ) .OR. D == 0
			D := 1
		EndIf
	Else
...
*-----------------------------------------------------------------------------------------*
* Descri็ใo        * Static Function para retornar a representa็ใo do cod de barras - BCO *
*				   * CAIXA para convenio com 7 posi็๕es. 								  *
...
Local cCarteira  	:= AllTrim(SEE->EE_CODCART)+"4" //Carteira 1 indica registrada, e o 4 indica emissใo do boleto pelo beneficiแrio
Local cMoed      	:= "9"
...
/*
COMPOSIวรO DO CำDIGO DE BARRAS 
O c๓digo de barras para a cobran็a cont้m 44 posi็๕es dispostas da seguinte forma: 
Posi็ใo Tamanho Picture Conte๚do Observa็ใo 
01 – 03 3 9 (3) Identifica็ใo do banco (104) 
04 – 04 1 9 C๓digo da moeda (9 - Real) 
05 – 05 1 9 DV Geral do C๓digo de Barras Nota 2 / Anexo I 
06 - 09 4 9 Fator de Vencimento Anexo II 
10 - 19 10 9 (8) V99 Valor do Documento 
##### ABAIXO O CAMPO LIVRE
20 – 25 6 9 (6) C๓digo do Beneficiแrio 
26 – 26 1 9 (1) DV do C๓digo do Beneficiแrio Nota 3 /Anexo VI 
27 – 29 3 9 (3) Nosso N๚mero - Seqü๊ncia 1 Nota 1 
30 – 30 1 9 (1) Constante 1 Nota 1 
31 – 33 3 9 (3) Nosso N๚mero - Seqü๊ncia 2 Nota 1 
34 – 34 1 9 (1) Constante 2 Nota 1 
35 – 43 9 9 (9) Nosso N๚mero - Seqü๊ncia 3 Nota 1 
...
*-----------------------------------------------------------------------------------------*
* Descri็ใo        * Static Function para retornar expressใo do codigo de barra BCO ITAU  *
*-----------------------------------------------------------------------------------------*
...
Static Function CodBarra_341()   //ITAU
	...
	Local cConta 	 	:= STRZERO(VAL(SEE->EE_CONTA),5)        // Alterado em 09/01/18 porque manual do banco Itau nใo considera o digito para calculo do DAC nosso numero
	...
	Local cSequencial := StrZero(Val(AllTrim(SEE->EE_FAXATU)),8)   //Alterado em 05/01/2018                     ท
	...
	cNNumImp	:= cCarteira + "/" + cSequencial +"-"+ cNNumDac 			 
	cNossoNum	:= cCarteira + cSequencial + cNNumDac 
	...
	Else
		SEE->(RecLock("SEE",.F.))
		SEE->EE_FAXATU := Soma1(cSequencial)  
		SEE->(MsUnLock())
	EndIf 

	//Atualiza o NUMBCO (nosso numero)
	SE1->(RecLock("SE1",.F.))
	SE1->E1_NUMBCO := cSequencial
	SE1->(MsUnlock())   
	...
	cRetorno += cAgencia //N.บ da Ag๊ncia cedente
	cRetorno += cContaSD //N.บ da Conta Corrente
	cRetorno += AllTrim(Str(__Modulo10(cAgencia+cContaSD))) //DAC [Ag๊ncia/Conta Corrente] (Anexo 3)
...
*-----------------------------------------------------------------------------------------*
* Descri็ใo        * Static Function para retornar expressใo da linha digitavel BCO INDUS-*
*				   * TRIAL.																  *
*-----------------------------------------------------------------------------------------*
* Uso              * Especifico da User Function RFIN002()   							  *
*-----------------------------------------------------------------------------------------*
...
Static Function LinhaDig_341()  //ITAU
	...
	Local cConta 	 	:= STRZERO(VAL(SEE->EE_CONTA),5)+SEE->EE_DVCTA
	Local cAgencia		:= STRZERO(VAL(SEE->EE_AGENCIA),4) //Right(SEE->EE_AGENCIA,4)
	Local cSequencial	:= StrZero(Val(AllTrim(SE1->E1_NUMBCO)),8)    

	Local cNNum			:= cAgencia + cConta + cCarteira + cSequencial	// digito verifacador Agencia + Conta + Carteira + Nosso Num 
	Local cNNumDac		:= AllTrim(Str(__Modulo10(cNNum))) 				//DAC nosso numero
	...
	aLinha[1] := SUBSTR(SE1->E1_CODBAR,1,3) 			//AAA = C๓digo do Banco na Cโmara de Compensa็ใo (Ita๚=341)
	aLinha[1] += SUBSTR(SE1->E1_CODBAR,4,1) 			//Fixo tipo de moeda (9=Real) 
	aLinha[1] += cCarteira 								//CCC =C๓digo da carteira de cobran็a
	aLinha[1] += SUBSTR(SE1->E1_NUMBCO,1,2) 			//DD = Dois primeiros dํgitos do Nosso N๚mero	//ALTERADO EM 17/04/2024 POIS O NUMBCO PASSOU A SER DE 8 DIGITO SEM O COD AGENCIA
	...
	aLinha[2] := SUBSTR(SE1->E1_NUMBCO,3,6) 			// DDDDDD= Restante do Nosso N๚mero
	aLinha[2] += cNNumDac					 			//E = DAC do campo [Ag๊ncia/Conta/Carteira/ Nosso N๚mero] 
	aLinha[2] += SUBSTR(cAgencia,1,3) 					//FFF =Tr๊s primeiros n๚meros que identificam a Ag๊ncia
	...
	aLinha[3] := SUBSTR(cAgencia,4,1) 					//F =Restante do n๚mero que identifica a ag๊ncia
	aLinha[3] += StrZero(Val(SUBSTR(cConta,1,6)),6) 	//GGGGGG = N๚mero da conta corrente + DAC
	...
	aLinha[4] += SUBSTR(SE1->E1_CODBAR,5,1) 			//DAC do C๓digo de Barras (Anexo 2)
...
static function FIncLog()
	...
	//inserindo integra็ใo de boletas
	chkfile('Z18')
	if cAmbiente == '2'
		dbSelectArea('Z18')
		Z18->(dbSetOrder(2))
