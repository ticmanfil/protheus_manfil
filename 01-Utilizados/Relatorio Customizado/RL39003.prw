...
Data da Criacao---: 06/11/2025
===============================================================================================================================
Descrição---------: Este programa serve para IMPRIMIR ROMANEIO DE CARGA
===============================================================================================================================
Uso---------------: 39 - OMS
===============================================================================================================================
Parametros--------: Nenhum
...
=====================================================================================================================================
/*/
user function RL39003(pCarga, pSeqCarga)

	local	cControle		as caracter,;
			cImp			as caracter,;
			cNArq			as caracter

	local	lAdToLegacy		as logical,;
			cPath			as caracter,;
			lDisabeSetup	as logical	// .t. desabilita a tela de configuração de impressao

	private	lImprimiu		as logical
	...
	cImp		:= ''
	cNArq		:= 'romaneio_'+cControle+'_'+dtos(date())+strtran(time(),':','')
...
Static Function MontaTRB(cControle)
	...
	cQry := 'exec PR_RL39003 @FILIAL = "'+fwxFilial('Z11')+'", @CONTROLE = "'+cControle+'"'
